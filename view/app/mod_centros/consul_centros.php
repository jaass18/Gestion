...
$objagent=new agent;
$consulta=$objagent->consulta_sucur();
?>
...
<tr class="nada" >
    ...
    Sucursal</font> <font color="#FF0000" size="-1"> ]</font> </span>
            </td>
   ...
   Direcci&oacute;n </font> <font color="#FF0000" size="-1"> ]</font> </span></td>
...
if($consulta) {
	...
	?>
		  ...
		  <tr id="fila-<?php echo $agent['idsucursal'] ?>" >
			  <td width="112" align="center" valign="top"><?php echo $agent['idsucursal'] ?></td>
			  <td width="207" align="center" valign="top"><?php echo $agent['nombre'] ?></td>
			<td width="162" align="center" valign="top"><?php echo $agent['direccion']; ?></td>
              <td width="89" align="center" valign="top"><span class="modi"><a href="view/app/mod_sucursales/edit_sucur.php?idsucursal=<?php echo $agent['iduser'] ?>"><img src="view/admin/img/32x32/file_edit.png" alt="Editar" width="22" height="22" border="0" title="Editar" /></a></span></td>
			  <td width="144" align="center" valign="middle"><span class="modi" style="font-family:Trebuchet MS; font-weight:bold;  font-size:10px;"><a href="view/app/mod_sucursales/edit_sucur.php?idsucursal=<?php echo $agent['idsucursal'] ?>" style="text-decoration:none;  ">EDITAR</a></span></td>
			  <td width="89" align="center" valign="top"><span class="dele"><a onClick="EliminarSucursal(<?php echo $agent['idsucursal'] ?>); return false" href="view/app/mod_sucursales/del_sucur.php?idsucursal=<?php echo $agent['idsucursal'] ?>"><img src="view/admin/img/32x32/file_delete.png" alt="Eliminar" width="22" height="22" border="0" title="Eliminar" /></a></span></td>
			  <td width="144" align="center" valign="middle"><span class="dele" style="font-family:Trebuchet MS; font-weight:bold;  font-size:10px;"><a onClick="EliminarSucursal(<?php echo $agent['idsucursal'] ?>); return false" href="view/app/mod_sucursales/del_sucur.php?idsucursal=<?php echo $agent['idsucursal'] ?>" style="text-decoration:none; ">ELIMINAR</a></span></td>
		  </tr>
