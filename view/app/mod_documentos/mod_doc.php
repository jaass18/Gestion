...
<span class="variable2" style=" font-family:'Lucida Sans Unicode';text-align:center; font-size:10px;">Selecciona la acción a Realizar</span></div>
   ...
   <div style="width:115px; height:40px;  background: #D41439; padding:5px;"><a  style="text-transform:uppercase; text-decoration:none; color:#fff; font-family:Arial;font-size:12px;	font-stretch:narrower; font-weight:bold;"href="consul_doc.php"  >Modificar <br />
   Documentos</a></div></span>
   </div>
