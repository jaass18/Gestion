...
<br />
 ...
 <table style="width:800px;" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="middle"><input type="text" name="costo" id="costo"  class="required" value="<?php echo $agent['costo']?>" size="6" /></td>
    <td align="center" valign="middle"><input type="text" name="descuento" id="descuento"  class="required" value="<?php echo $agent['descuento']?>" size="6"/></td>
...
<div style="overflow-x:hidden ; height:100px; overflow-y:scroll;">
  ...
  <?php 
	...
	if ( ($var2 == $var )){
		//echo "$var --  $var2";
		?> <input name="chkinfo" id="chkinfo" type="checkbox" checked="checked"  value="<?php echo $check['idsucursal']?>">
		<?php
		}else{  ?> 
		
        <input name="chkinfo" id="chkinfo" type="checkbox"  value="<?php echo $check['idsucursal']?>">					        <?php }
	?>
   </td>
