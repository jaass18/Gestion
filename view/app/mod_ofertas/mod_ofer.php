...
$(document).ready(function(){
  ...
  <div align="center" style="padding-top:80px">
   ...
   <span id="nuevo"> <a  href="nuevo_add_user.php"><img src="view/admin/img/64x64/document_add.png" width="64" height="64" border="0" /></a><br /><br />
    ...
    <span id="nuevo"><a  href="nuevo_add_user.php" style="text-transform:uppercase; text-decoration:none; color:#fff; font-family:Arial;font-size:12px;	font-stretch:narrower; font-weight:bold;" >Agregar <br />Ofertas</a> </span>
   </div></div>
   ...
   <div style="width:115px; height:40px;  background: #D41439; padding:5px;"><a  style="text-transform:uppercase; text-decoration:none; color:#fff; font-family:Arial;font-size:12px;	font-stretch:narrower; font-weight:bold;"href="users/consulta_user.php"  >Modificar <br />Ofertas</a></div></span>
   </div>
