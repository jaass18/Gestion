...
<div align="center" style=" display:block;height:20px; width:900px;  background-color:#444;">
   ...
   <span id="documentos"><a  href="mod_doc.php" style="text-transform:uppercase; text-decoration:none; color:#fff; font-family:Arial;font-size:12px;	font-stretch:narrower; font-weight:bold;"> <font color="#FF0000">[</font> Documentos <font color="#FF0000">]</font></a></span>

   
   </div></div>
   <div style="width:125px;  float:left; margin-right:5px; display:block;">
   <div style="width:115px; height:16px; background: #444; padding:2px;">
   <span id="ofertas"><a  href="mod_doc.php" style="text-transform:uppercase; text-decoration:none; color:#fff; font-family:Arial;font-size:12px;	font-stretch:narrower; font-weight:bold;"><font color="#FF0000">[</font> Menu 2 <font color="#FF0000">]</font></a></span>
  </div></div>
