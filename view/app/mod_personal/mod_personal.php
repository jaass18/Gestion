...
$(document).ready(function(){
	...
	$("#editar a").click(function(){
		...
		$.ajax({
			type: "GET",
			url: 'view/app/mod_personal/consul_personal.php',
			success: function(datos){
				$("#formulario").html(datos);
				$("#wait").hide();
			}
	...
	$("#del a").click(function(){
		...
		$.ajax({
			type: "GET",
			url: 'users/consulta_del_personal.php',
			success: function(datos){
				$("#formulario").html(datos);
				$("#wait").hide();
			}
	...
	$("#reg_list").click(function(){
		...
		$.ajax({
			type: "GET",
			url: 'users/consulta_personal.php',
			success: function(datos){
				$("#formulario").html(datos);
				$("#wait").hide();
			}
  ...
  <div align="center" style="padding-top:80px">
   <span class="variabletit" style="color:#666666"> <font color="#FF0000" size="+2">[ </font> <font color="#333" size="+1">
    Administrar Personal </font> <font color="#FF0000" size="+2"> ]</font> </span>
   ...
   <span id="nuevo"> <a  href="nuevo_add_user.php"><img src="view/admin/img/64x64/document_add.png" width="64" height="64" border="0" /></a><br /><br />
    ...
    <span id="nuevo"><a  href="nuevo_add_user.php" style="text-transform:uppercase; text-decoration:none; color:#fff; font-family:Arial;font-size:12px;	font-stretch:narrower; font-weight:bold;" >Agregar <br />Personal</a> </span>
   </div></div>
   ...
   <div style="width:115px; height:40px;  background: #D41439; padding:5px;"><a  style="text-transform:uppercase; text-decoration:none; color:#fff; font-family:Arial;font-size:12px;	font-stretch:narrower; font-weight:bold;"href="users/consulta_user.php"  >Modificar <br />Personal</a></div></span>
   </div>
